...
//                System.out.println("::3?:"+clientSentence+":");
                ...
                if(clientSentence!=null){
                    ...
                    if(header1.startsWith("REGISTER TOSEND ")){
                        ...
                        outToClient.flush();
                    }else if(header1.startsWith("SEND ")){
                        String recipient=header1.substring(4, ar[0].length()).trim();
...
class ServerSocketThreadRecv implements Runnable {
    ...
    public void run() {
        ...
        try{
            String responseSentence="";
            String clientSentence = inFromClient.readUTF().trim();
            
            if(clientSentence.startsWith("REGISTER TORECV ")){
                clientName=clientSentence.substring(16, clientSentence.length()).trim();
